package com.test.kharchenko.heartrate.ui.components.scrollbar
...
private fun InternalLazyColumnScrollbar(
    ...
    fun offsetCorrection(top: Float): Float {
        val topRealMax = (oneHundredPercentDecimal - normalizedThumbSizeReal).coerceIn(
            0f,
...
private fun determineVisibilityState(
    ...
    return if (lastItem != null && lastItem.index == totalItemCount - 1
        && (lastItem.size + lastItem.offset) <= viewportSize
